<section class="content-header">
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <a href="<?= site_url('content/page/slider/tambah') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
        <br><br>
        ...
        <table class="table datatables">
          <thead class="bg-success">
            <tr>
              ...
              <th style="width: 35%">Judul Slider</th>
          ...
          <tbody>
            ...
            foreach ($list as $row) { $n++; ?>
              <tr>
                ...
                <td>
                  <small>
                  <a class='text-warning' data-toggle="tooltip" title="Ubah" href="<?= site_url('content/page/slider/edit/'.$row['content_id']) ?>"><i class="fa fa-edit"></i></a> &nbsp;
                  
                  <a class='text-danger' href="<?= site_url('delete/content/slider/'.$row['content_id']) ?>" onclick="return confirm('Apakah kamu yakin menghapus data ini ?')" data-toggle="tooltip" title="Hapus Data"><i class="fa fa-trash"></i></a></small>
                </td>
              </tr>
            <?php } ?>
          </tbody>
